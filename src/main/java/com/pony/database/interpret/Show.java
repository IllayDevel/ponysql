        ...
        try {
            ...
            switch (show_type) {
                ...
                case "jdbc_table_types":
                    ...
                    for (String supported_type : supported_types) {
                        temp_table.newRow();
                        temp_table.setRowObject(TObject.stringVal(supported_type),
